...
| 6: Governance and explanation | 10 h | Correct SHAP feature mapping; additivity tests; reason categories; demographic exclusion/invariance review; validation-only subgroup report; model card; risk register | Explanations are dimensionally correct, review triggers are dispositioned, and feature use is governed | Responsible AI and model-risk ownership |
...
G3 governance promotion is completed separately in Week 6; local serving is not
presented as external production approval.

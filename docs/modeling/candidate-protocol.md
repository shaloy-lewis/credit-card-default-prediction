...
5. The corrected Week 6 protocol uses demographic exclusion/invariance evidence,
validation-only subgroup analysis, native-SHAP review, and an audit-only feature decision.

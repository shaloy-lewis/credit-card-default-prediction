...
audit view. ADR 0002 directs the later governance gate to use exclusion,
invariance, and subgroup review rather than a new fitted ablation model. They
were never baseline predictors.

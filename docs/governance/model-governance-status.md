...
| G4 release readiness | Open | Release A explicitly defers this evidence | Robustness/population-shift stress, batch/API parity, registry, scanning, rollback, and runbooks |
